    ...
    <>
      <Tabs defaultValue="department" className="w-full h-auto relative">
        ...
        <TabsContent value="department" className='h-auto '>
          ...
          <div className='mt-5 w-full h-[530px] grid grid-cols-2 grid-rows-2 gap-3'>
            <Link
              ...
              <Link href='/events'>
                <Card className="relative h-full flex flex-col p-3 bg-stone-900 group hover:bg-stone-800/80 transition-colors">
                  ...
                  <div className='relative flex-1'>
                    <ChevronRightCircle className='absolute h-7 w-7 stroke-[#d6d4d4] bottom-0 group-hover:translate-x-2 transition-all duration-300 ease-in-out' />
                  </div>
                </Card>
              </Link>
